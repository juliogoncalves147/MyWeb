  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        hero: 'linear-gradient(135deg,  rgba(209,215,225,1) 60%, rgba(10,10,10,0.95) 60%)',
        'hero-mobile':
          'linear-gradient(137deg, rgba(209,215,225,1) 60%, rgba(10,10,10,1) 60%)',
        tech: "linear-gradient(165deg, rgba(20, 20, 20, 1) 100%, rgba(20, 20, 20, 1) 100%), url('/src/assets/backgrounds/nairobi.png')",
      },
      fontFamily: {
        arenq: ['Arenq'],
        beckman: ['Beckman'],
